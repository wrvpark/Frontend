...
// API calls
import { postServices } from '../../../api/apifunction'

const Item = List.Item;

/**
 * Class that handle rendering and logic behind confirmation modal for Services Section
 * 
...
class ConfirmationModal extends Component {
            ...
            <>
                <Modal show={this.state.isOpen} onHide={this.closeModal}>
                    ...
                    <Modal.Body>
                        ...
                        <Item>
                            {/* <span>File Attached: {imagesFormatted}</span> */}
                    ...
                    <Modal.Footer>
                        ...
                        {/* <Button variant="secondary" className='det_done_button' onClick={this.postForum}> */}
                        {/* CONFIRM
            </Button> */}
                    </Modal.Footer>
                </Modal>
    ...
    postToServer = async () => {
        ...
        // Check if we are updating or 1creating post
        let id = "";
        ...
        // Post request
        const response = await postServices(id, subcategory_id, title,
