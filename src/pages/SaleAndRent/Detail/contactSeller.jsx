...
/**
 * Contact creator modal for Sale & Rent and handles submitting email to creator
 * 
 * @author Charles Breton Chen Zhao
 * @returns Contact creator modal for Sale & Rent
 */
            ...
            <>
                <Modal show={this.state.isOpen} onHide={this.closeModal}>
                    ...
                    <Modal.Body>
                        ...
                        <input type="hidden" name="section" value="Sale & Rent"></input>
                    ...
                    <Modal.Footer>
                        <Button type="submit" variant="secondary" className='det_done_button'>  
                            SEND MESSAGE 
                        </Button>{/*onClick={() =>this.postResponse()}*/}
                    </Modal.Footer>
                    </form>
                </Modal>
            </>
