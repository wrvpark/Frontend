...
/**
 * Contact creator modal for Services and handles submitting email to creator
 * 
 * @author Charles Breton Chen Zhao
 * @returns Contact creator modal for Services
 */
            ...
            <>
                <Modal show={this.state.isOpen} onHide={this.closeModal}>
                    ...
                    <Modal.Body>
                        ...
                        <input type="hidden" name="section" value="Services"></input>
                        <input type="hidden" name="sendTo" value={this.props.post.creator.email}></input> {/*{this.props.creator.email}*/}
                    </Modal.Body>
                    <Modal.Footer>
